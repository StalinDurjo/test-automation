...
export const startDockerEnvironment = async (environmentConfigList, testConfig) => {
...
export const checkDockerWordpressTestReadiness = async (networks: string[], configuredContainerCount: number) => {
  try {
